...
public interface SessionRepository extends JpaRepository<SessionEntity,String> {
    ...
    @Query(nativeQuery = true,value = "select * from sessions where session_id=:sessionId AND type=:type")
    SessionEntity findBySessionId(@Param("sessionId") String sessionId,@Param("type") String type);
