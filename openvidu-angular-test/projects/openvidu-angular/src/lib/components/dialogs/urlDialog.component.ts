...
export class UrlDialogTemplateComponent {
	constructor(public dialogRef: MatDialogRef<UrlDialogTemplateComponent>, @Inject(MAT_DIALOG_DATA) public data: DialogData) {}
