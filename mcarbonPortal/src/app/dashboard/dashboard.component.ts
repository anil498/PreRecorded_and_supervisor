...
export class DashboardComponent implements OnInit {
  ...
  constructor(private restService: RestService) {
    const dashboard = this.restService.getData().Dashboard;
  ...
  ngOnInit() {
    ...
    var accountArray = Object.values(this.accounts.monthlyAccountCreation).map(
      Number
    );
    ...
    var sessionArray = Object.values(this.sessions.monthlySessionCreation).map(
      Number
    );
